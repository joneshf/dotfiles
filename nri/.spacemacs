...
(defun dotspacemacs/user-config ()
  (require 'helm-bookmark) ;; This is here because of some bug.
...
you should place your code here."
  ...
  (setq enh-ruby-hanging-paren-deep-indent-level 1)
